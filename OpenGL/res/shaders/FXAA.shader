...
vec2 u_texelStep = vec2(1.0 / screen_width,1.0 / screen_height);
int u_showEdges = 0;
uniform bool fxaaOn;
...
void main(void)
{
	...
	samplingDirection = clamp(samplingDirection * minSamplingDirectionFactor, vec2(-maxSpan), vec2(maxSpan)) * u_texelStep;
