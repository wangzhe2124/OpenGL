...
int main(void)
{
  ...
  glm::vec3(-1.3f,  1.0f, -1.5f)
    ...
    //创建纹理
    Texture texture;
    texture.BindData("res/textures/container2_diffuse.png", "texture_diffuse");

    Texture texture2;
    texture.BindData("res/textures/container2_specular.png", "texture_specular");
    texture.Bind(0);
    texture2.Bind(1);
   ...
   // Mesh mesh1;
   // mesh1.setupMesh(vertex,  index,  t, cubeshader);
    ...
    while (!glfwWindowShouldClose(window))
    {
       ...
       // lightpos.y = sin(glfwGetTime() / 2.0f) * 1.0f;
        ...
        for (unsigned int i = 0; i < 10; i++)
        {
            ...
            renderer.DrawArray(lightva, cubeshader);
