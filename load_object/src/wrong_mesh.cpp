...
int main(void)
{
  ...
  glm::vec3(-1.3f,  1.0f, -1.5f)
    ...
    //texture.BindData("res/textures/container2_diffuse.png", "diffuse");
    
    //texture2.BindData("res/textures/container2_specular.png", "specular");

    Texture texture2;
    /*mesh1.BindTexture(texture, "res/textures/container2_diffuse.png", "diffuse", cubeshader, 0);

    mesh1.BindTexture(texture2, "res/textures/container2_specular.png", "specular", cubeshader, 1);
    mesh1.BindSlot(texture, cubeshader, 0);
    mesh1.BindSlot(texture2, cubeshader, 1);*/
    std::vector<Texture> textures = { texture, texture2 };
    textures[0].Bind(0);
    textures[1].Bind(1);
    texture.BindData("res/textures/container2_diffuse.png", "diffuse");
    texture2.BindData("res/textures/container2_specular.png", "specular");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec3 lightpos = glm::vec3(1.0f, 10.0f, 0.0f);
        //lightpos.z += -1.0f;
